...
class Store {
  ...
  fetchSKV(ranges, versions, options = {}, callback) {
    ...
    let err = null
    this._eachCellInRanges(dbTxn, ranges, (k, lastMod, data) => {
    ...
    process.nextTick(() => err ? callback(err) : callback(null, {results, versions:{[this.source]: [minVersion, this.version]}}))
  }
