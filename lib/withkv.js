...
module.exports = function wrap(store) {
  ...
  const wrapped = {
    ...
    subscribe(qtype, initialKV, versions, opts = {}, outerlistener, callback) {
      if (qtype !== 'kv') return store.subscribe(
        qtype, initialKV, versions, opts, outerlistener, callback
      )
      ...
      innerSub = store.subscribe('sortedkv', initialSKV, versions, opts, listener, callback)
      sub = {
        opts: innerSub.opts,
